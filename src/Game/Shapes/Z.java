...
public class Z implements Shape {
    ...
    /**
     * Creates a new Z piece in the "STATISTICS" box
...
//        }
        for (int i = 0; i < 4; i++) {
            ...
            t.setImage(new Image("Z_L_" + level + ".png"));
            if (i == 0) {
                t.setCoordinates(STAT_X_COORDINATES[0], STAT_Y_COORDINATES[0]);
            } else if (i == 1) {
                t.setCoordinates(STAT_X_COORDINATES[1], STAT_Y_COORDINATES[0]);
            } else if (i == 2) {
                t.setCoordinates(STAT_X_COORDINATES[1], STAT_Y_COORDINATES[1]);
            } else {
                t.setCoordinates(STAT_X_COORDINATES[2], STAT_Y_COORDINATES[1]);
            }
            tiles.add(t);
        }
    }
