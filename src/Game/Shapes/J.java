...
public class J implements Shape {
    ...
    /**
     * Creates a new J piece in the "STATISTICS" box
...
//        }
     ...
     */
    public J(int level, boolean next) {
        level %= LEVEL_IMAGE_LOOP;
//        while (level >= LEVEL_IMAGE_LOOP) {
//            level -= LEVEL_IMAGE_LOOP;
//        }
